      ...
      measure( "Vector", "Search", [&]( const Book & book) {dataStructureUnderTest.emplace_back(book);}, [&](auto&) -> Book * {
        ...
        ///////////////////////// TO-DO (5) //////////////////////////////
          ...
          /// book is not in the container.
            //auto i = std::find(dataStructureUnderTest.begin(), dataStructureUnderTest.end(), target_isbn);
            auto i = std::find_if(dataStructureUnderTest.begin(), dataStructureUnderTest.end(), [&target_isbn](const Book& obj) { return obj.isbn()==target_isbn; });
            if (i != dataStructureUnderTest.end()){return &*i;}
            else{ return nullptr;}
    ...
    {  // 1b:  Insert at the back of a singly linked list
      ...
      measure( "SLL", "Insert at the back", [&]( const Book & book )  {
        ...
        ///////////////////////// TO-DO (11) //////////////////////////////
          ...
          auto before_end = std::next(dataStructureUnderTest.before_begin(),std::distance(dataStructureUnderTest.begin(),dataStructureUnderTest.end()));

          dataStructureUnderTest.insert_after(before_end,book);
        /////////////////////// END-TO-DO (11) ////////////////////////////
    ...
    {  // 2b:  Remove from the back of a singly linked list
      ...
      measure( "SLL", "Remove from the back", [&]( const Book & ) {
        ...
        ///////////////////////// TO-DO (13) //////////////////////////////
          ...
          auto end = dataStructureUnderTest.end();

          if (dataStructureUnderTest.empty()){
            return;
          }
          else{
            while(current != end){
  ...
  void collect_BinarySearchTree_measurements()
  {
    {  // 1d:  Insert into a binary search tree
      ...
      measure( "BST", "Insert", [&]( const Book & book )  {
        ...
        ///////////////////////// TO-DO (16) //////////////////////////////
          ...
          dataStructureUnderTest.insert(std::pair<std::string,Book>(book.isbn(), book));
        /////////////////////// END-TO-DO (16) ////////////////////////////
    ...
    {  // 3d: Search for an element in a binary search tree
      ...
      measure( "BST", "Search", [&]( const Book & book) {dataStructureUnderTest.emplace( book.isbn(), book );}, [&](auto&) -> Book * {
        ...
        auto i = std::find_if(dataStructureUnderTest.begin(), dataStructureUnderTest.end(), [&target_isbn](std::pair<std::string,Book> const & obj){return obj.first == target_isbn;});
        if (i != dataStructureUnderTest.end()){return &i->second;}
          else{ return nullptr;}
