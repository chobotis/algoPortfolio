...
int main()
{
  try
  {
    ...
    auto carts = mybookstore.makeShoppingCarts();
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      auto booksales = mybookstore.processCustomerShoppingCarts( shoppingCarts );
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      auto inv = mybookstore.inventory();
      inv.erase("9802161748");
    ...
    ///////////////////////// TO-DO (5) //////////////////////////////
      ...
      std::cout <<"\n\n\n";
       mybookstore.reorderItems(booksales);
    /////////////////////// END-TO-DO (5) ////////////////////////////
  }
